...
window.onload = function init() {      // or window.addEventListener('load',init())
    num1.addEventListener('change', add);
    num2.addEventListener('change', add);
    num3.addEventListener('change',subtract);
    num4.addEventListener('change', subtract);
    num5.addEventListener('change',multiply);
    num6.addEventListener('change', multiply);
    num7.addEventListener('change',divide);
    num8.addEventListener('change', divide);
    num9.addEventListener('change', remainder);
    num10.addEventListener('change', remainder);
